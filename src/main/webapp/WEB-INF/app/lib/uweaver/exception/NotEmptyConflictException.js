...
define(['uweaver/lang', 'uweaver/string'], function(lang, string) {
     ...
     *
     *
     * @constructor NotEmptyConflictException#
     * @author  Jason Lin
     * @since   1.0
    ...
    var props = {
        name: "NotEmptyConflictException",
        message: "Can not be NULL or empty string! Property: ${1}, Object: ${0}.",
    ...
    var NotEmptyConflictException = declare(Base, {
        initialize: initialize,
        toString: toString
    }, props);

    return NotEmptyConflictException;
});
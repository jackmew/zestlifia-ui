...
define(['underscore', 'uweaver/lang', 'backbone', 'uweaver/data/Item',
    'uweaver/net', 'uweaver/converter'], function(_, lang, Backbone, Item, net, converter) {

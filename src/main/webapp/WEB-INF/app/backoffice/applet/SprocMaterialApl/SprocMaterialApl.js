...
define(['underscore', 'jquery', 'uweaver/applet/TDIApplet', 'uweaver/widget/Triggers', 'uweaver/widget/Popup',
    ...
    var LOGGER = new Logger("SprocMaterialApl");
    ...
    function initialize(config) {
        ...
        this._title = i18n.translate("原料特採申請");
    }
    ...
    function onGridDraftSelect(evt) {
        ...
        var path = './applet/SprocMaterialApl/gadget/';
    ...
    function onCommandTrigger(event) {
        ...
        switch (value.toUpperCase()) {
            case SprocMaterialApl.COMMAND.CREATE:
                this.create();
                break;
            case SprocMaterialApl.COMMAND.OPEN:
                this.open();
                break;
            default:
                break;
    ...
    var SprocMaterialApl = declare(Base, {
